...
func MergeManifests(content string, siteBuildPath string) {
	...
	if err != nil {
		...
		log.Println(fmt.Sprintf("*** Manifest generation finished. You can run now: openshift-install create cluster --dir=%s/final_manifests to create the site cluster ***", siteBuildPath))
	}
